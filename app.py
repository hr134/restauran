...
# Session Security Configuration (Critical for production/Render)
app.config['SESSION_COOKIE_SECURE'] = os.environ.get('RENDER_EXTERNAL_URL') is not None  # HTTPS only in production
